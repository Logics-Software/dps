    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-white d-flex flex-column flex-md-row align-items-md-center justify-content-md-between">
                <h4 class="mb-0">Order Baru <?= icon('arrow-right', 'me-0 mb-1', 14)?> <?= htmlspecialchars($noorder) ?></h4>
            </div>
            <div class="card-body">
                <form method="POST" action="" id="orderForm">
                    ...
                    <div class="table-responsive order-items-wrapper">
                        ...
                        <div class="order-items-cards" id="detailCardsContainer"></div>
                ...
                <div class="modal-footer modal-footer-muted justify-content-between align-items-center">
                    <div class="me-auto">
                        <button type="button" class="btn btn-info btn-lg" id="openStockPriceModal">
                            <?= icon('boxes-stacked', 'me-2', 18) ?> Stok &amp; Harga
                        </button>
                    </div>
                ...
                card.innerHTML = `
                    ...
                    <div class="order-item-card-body">
                        <div class="order-item-card-row">
                            <span class="order-item-card-value">${formatQty(jumlah)} ${satuanBarang} x Rp. ${integerFormatter.format(Math.round(harga))} (${discountPercent.toFixed(2).replace('.', ',')}%) = Rp. ${integerFormatter.format(Math.round(total))}</span>
                            <input type="hidden" name="detail_jumlah[]" value="${jumlah.toFixed(2)}">
                            <input type="hidden" name="detail_harga[]" value="${harga.toFixed(2)}">
                            <input type="hidden" name="detail_discount[]" value="${discountPercent.toFixed(2)}">
                            <input type="hidden" name="detail_totalharga[]" value="${total.toFixed(2)}">
