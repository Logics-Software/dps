                        ...
                        <table class="table table-striped table-hover align-middle">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="th-sortable <?= ($sortBy ?? 'tanggalpenjualan') === 'noorder' ? (($sortOrder ?? 'DESC') === 'ASC' ? 'sorted-asc' : 'sorted-desc') : '' ?>">
                                        <a href="<?= getSortUrlPenjualan('noorder', $sortBy ?? 'tanggalpenjualan', $sortOrder ?? 'DESC', $search ?? '', $periode ?? 'today', $startDate ?? '', $endDate ?? '', $statuspkp ?? '', $perPage ?? 10) ?>" class="text-decoration-none text-dark">
                                            No Order
                                        </a>
                                    </th>
                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            ...
                            <li class="page-item <?= $page >= $totalPages ? 'disabled' : '' ?>">
                                <a class="page-link" href="<?= buildPenjualanQuery($page + 1, $perPage, $search, $periode, $startDate, $endDate, $statuspkp, $sortBy ?? 'tanggalpenjualan', $sortOrder ?? 'DESC') ?>">Next</a>
                            </li>
                        </ul>
                    </nav>
                    <?php endif; ?>
