                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                                <a class="page-link" href="?page=<?= $page - 1 ?>&per_page=<?= $perPage ?>&search=<?= urlencode($search) ?>&status=<?= urlencode($status) ?>&statuspkp=<?= urlencode($statuspkp) ?>&sort_by=<?= $sortBy ?>&sort_order=<?= $sortOrder ?>">Previous</a>
                            </li>
                            <?php
                            $maxLinks = 3;
                            ...
                            $buildLink = function ($p) use ($perPage, $search, $status, $statuspkp) {
                                return '?page=' . $p
                                    . '&per_page=' . $perPage
                            ...
                            <li class="page-item <?= $page >= $totalPages ? 'disabled' : '' ?>">
                                <a class="page-link" href="?page=<?= $page + 1 ?>&per_page=<?= $perPage ?>&search=<?= urlencode($search) ?>&status=<?= urlencode($status) ?>&statuspkp=<?= urlencode($statuspkp) ?>&sort_by=<?= $sortBy ?>&sort_order=<?= $sortOrder ?>">Next</a>
                            </li>
                        </ul>
                    </nav>
                    <?php endif; ?>
