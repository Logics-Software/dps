                    ...
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                                <a class="page-link" href="<?= buildPerubahanhargaQuery($page - 1, $perPage, $search, $dateFilter, $rawStartDate, $rawEndDate, $sortBy ?? 'tanggalperubahan', $sortOrder ?? 'DESC') ?>">Previous</a>
                            </li>
                            <?php
                            $maxLinks = 3;
                            ...
                            <li class="page-item <?= $page >= $totalPages ? 'disabled' : '' ?>">
                                <a class="page-link" href="<?= buildPerubahanhargaQuery($page + 1, $perPage, $search, $dateFilter, $rawStartDate, $rawEndDate, $sortBy ?? 'tanggalperubahan', $sortOrder ?? 'DESC') ?>">Next</a>
                            </li>
                        </ul>
                    </nav>
                    <?php endif; ?>
