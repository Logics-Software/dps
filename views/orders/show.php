...
<div class="card">
	...
	<div class="card-body">
		<div class="row mb-3">
			<div class="col-md-3"><strong>Tanggal</strong><br><?= htmlspecialchars(date('d/m/Y', strtotime($order['tanggalorder'] ?? date('Y-m-d')))) ?></div>
			<div class="col-md-3"><strong>Customer</strong><br><?= htmlspecialchars($order['namacustomer'] ?? '-') ?></div>
			<div class="col-md-3"><strong>Status</strong><br><span class="badge bg-<?= ($order['status'] ?? '') === 'faktur' ? 'success' : 'warning' ?>"><?= htmlspecialchars(ucfirst($order['status'] ?? '')) ?></span></div>
			<div class="col-md-3"><strong>No Faktur</strong><br><?= htmlspecialchars($order['nopenjualan'] ?? '-') ?></div>
		</div>
